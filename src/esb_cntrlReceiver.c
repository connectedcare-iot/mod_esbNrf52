...
#define MAX_RF_CHANNEL   RF_MAX_CHANNEL_NUMBER  // h�chster beim Teach-Vorgang zu durchsuchender Funk-Kanal (vergleiche auch MAX_CHANNEL)
...
#define MAX_CHANNEL      78  // h�chster Kanal der verwendet werden soll. (vergleiche auch MAX_RF_CHANNEL)
                             // (Die Kan�le 79 und 80 wurden f?r FCC entfernt.)
